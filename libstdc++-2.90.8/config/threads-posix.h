...
// Defines
//
// Currently some STL code expects these macros
# define __STL_THREADS
# define __STL_PTHREADS
// Currently some GNU software expects these macros
// NB: this is defined by g++ if --enable-threads=posix was used to build
// the compiler
// # define _PTHREADS
