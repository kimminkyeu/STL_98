...
public:
  ...
  check_pointers()
  { 
    int_type g1 = reinterpret_cast<int_type>(this->eback());
    int_type g2 = reinterpret_cast<int_type>(this->gptr());
    int_type g3 = reinterpret_cast<int_type>(this->egptr());
    int_type p1 = reinterpret_cast<int_type>(this->pbase());
    int_type p2 = reinterpret_cast<int_type>(this->pptr());
    int_type p3 = reinterpret_cast<int_type>(this->epptr());
