...
/*
 * (1) capacity 값을 따로 들고 있지 않음. iterator간의 position 차이를 이용함.
 * (2) 그래서 멤버 데이터로 iterator start, iterator finish 를 통해 size를 계산하고
 *		iterator end_of_storage를 이용해서 capacity를 계산함.
 *
 * 
 * */
